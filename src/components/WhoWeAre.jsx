...
const WhoWeAre = () => {
  return (
    <section className='container mx-auto max-w-[1200px] mt-10 px-5 lg:px-5'>
     ...
     <img className='w-[400px] h-[424px] mt-28 hidden lg:flex' src="https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?ixid=M3wzOTE5Mjl8MHwxfHNlYXJjaHwzfHxzdGFydHVwfGVufDB8fHx8MTcwNjcxNDY3NHww&ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=848" alt="" />
     </div>
     <div className='text-base font-inter font-normal space-y-8 mt-5 col-span-3'>
        ...
        <button className='text-white bg-primary hover:bg-white border-primary hover:text-primary hover:font-medium transition-all duration-300 border-2 font-normal px-12 py-3 rounded-md'>Learn More</button>
     </div>
     <div></div>
     <div></div>
